...
export const SheetContent = React.forwardRef<HTMLDivElement, SheetContentProps>(
  ({ side = "right", className, children, onClose, showCloseButton = true, ...props }, forwardedRef) => {
    ...
    return createPortal(
      <dialog
        ...
        className={cn(
          ...
          "m-0 max-h-none max-w-none p-0 border-0",
          /* Full viewport positioning */
          "fixed inset-0 h-full w-full",
          /* Transparent dialog to show custom backdrop */
          "bg-transparent",
          /* Solid backdrop - NO BLUR (performance) */
          "backdrop:bg-black/80 backdrop:animate-in backdrop:fade-in-0 backdrop:duration-200",
