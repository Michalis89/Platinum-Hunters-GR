        ...
        <section className="rounded-3xl border border-slate-800/80 bg-slate-900/70 p-6 shadow-2xl backdrop-blur-xl md:p-8">
          <div className="mb-4">
            <p className="text-xs uppercase tracking-[0.25em] text-slate-400">
              Platinum Hunters • Προστασία Δεδομένων
            </p>
          ...
          <p className="text-sm leading-relaxed text-slate-300 md:text-base">
            Η παρούσα Πολιτική Απορρήτου εξηγεί πώς το{' '}
            <span className="font-semibold text-sky-400">Platinum Hunters</span> συλλέγει,
            αποθηκεύει και επεξεργάζεται τα προσωπικά σου δεδομένα όταν χρησιμοποιείς την ιστοσελίδα{' '}
            <a
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <p>
                ...
                δημιουργός του <span className="font-semibold text-sky-400">Platinum Hunters</span>.
                Για θέματα που αφορούν την προστασία προσωπικών δεδομένων, μπορείς να επικοινωνήσεις
                στο:
              </p>
              <p className="mt-1 font-medium text-sky-400">contact@platinumhunters.gr</p>
            </section>
            ...
            <section>
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5">
                ...
                <li>
                  ...
                  authentication cookies / session tokens μέσω Supabase και τυχόν απαραίτητα cookies
            ...
            {/* 4. Προσωπικά δεδομένα τρίτων υπηρεσιών */}
            <section>
              <h2 className="mb-2 text-lg font-semibold text-slate-50">
              ...
              <p>
                ...
                <span className="font-semibold text-sky-400">Platinum Hunters</span>.
              </p>
              <p className="mt-2">
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                <span className="font-medium text-sky-400">contact@platinumhunters.gr</span>. Θα
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                <span className="font-semibold text-sky-400">Platinum Hunters</span>, ούτε οι
