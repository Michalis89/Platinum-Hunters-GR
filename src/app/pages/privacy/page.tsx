          ...
          <section className="rounded-3xl border border-[var(--hb-border)] bg-[var(--hb-panel)] p-6 text-sm leading-relaxed text-[var(--hb-text)] shadow-xl backdrop-blur-md md:p-8 md:text-base">
            <div className="space-y-6">
              ...
              <section>
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  ...
                  <li>
                    ...
                    name, ονοματεπώνυμο, χώρα, bio, IDs (PSN, Xbox, Steam), αγαπημένα genres,
                    αγαπημένη πλατφόρμα, έτος έναρξης gaming.
                  </li>
                  <li>
                  ...
                  <li>
                    <span className="font-semibold">Τεχνικές πληροφορίες:</span> IP address, browser,
                    περίπου τύπο συσκευής, basic logs για λόγους ασφαλείας και debugging.
                  </li>
                  <li>
                ...
                <p className="mt-2 text-xs text-[var(--hb-muted)]">
                  Δεν συλλέγουμε εσκεμμένα ευαίσθητα προσωπικά δεδομένα (π.χ. υγεία, πολιτικές
                  απόψεις κ.λπ.).
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  ...
                  <li>
                    ...
                    κατάχρησης, κακόβουλης δραστηριότητας, μη εξουσιοδοτημένης πρόσβασης (νομική
                    βάση: έννομο συμφέρον).
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="mt-2">
                  Μπορείς να ρυθμίσεις τον browser σου ώστε να μπλοκάρει ή να διαγράφει cookies,
                  όμως κάτι τέτοιο μπορεί να επηρεάσει τη λειτουργία της Υπηρεσίας (π.χ.
                  αποσύνδεση).
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  ...
                  <li>
                    αν κριθεί απαραίτητο για την προστασία δικαιωμάτων, της ασφάλειας της Υπηρεσίας
                    ή άλλων χρηστών.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mt-2">
                  ...
                  . Θα προσπαθήσουμε να απαντήσουμε μέσα σε εύλογο χρονικό διάστημα και σύμφωνα με
              ...
              <section>
                ...
                <p>
                  Λαμβάνονται εύλογα τεχνικά και οργανωτικά μέτρα για την προστασία των δεδομένων
                  σου από μη εξουσιοδοτημένη πρόσβαση, απώλεια ή αλλοίωση. Ωστόσο, καμία διαδικτυακή
              ...
              <section>
                ...
                <p>
                  ...
                  άνθρωπο. Η διαδικασία αυθεντικοποίησης γίνεται μέσω της υπηρεσίας Supabase, η
                  οποία χρησιμοποιεί σύγχρονες τεχνικές κρυπτογράφησης (hashed &amp; salted),
                  σύμφωνα με τα σύγχρονα πρότυπα ασφαλείας.
                </p>
                <p className="mt-2">
                  Ως αποτέλεσμα, ούτε το{' '}
                  <span className="font-semibold text-[var(--hb-primary-strong)]">{SITE_NAME}</span>
                  , ούτε οι διαχειριστές του έχουν πρόσβαση στους πραγματικούς κωδικούς πρόσβασης.
                  Σε περίπτωση απώλειας κωδικού, η επαναφορά πραγματοποιείται αποκλειστικά μέσω
                  ασφαλών email verification links.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  αλλαγές στην Υπηρεσία, στους παρόχους ή στο νομικό πλαίσιο. Η ενημερωμένη εκδοχή
                  θα δημοσιεύεται στην ιστοσελίδα και, όπου κριθεί σκόπιμο, μπορεί να λάβεις
                  σχετική ειδοποίηση.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  . Σε περίπτωση ασυμφωνίας, υπερισχύουν οι διατάξεις που προστατεύουν περισσότερο
                  τα δικαιώματά σου ως υποκείμενο δεδομένων.
                </p>
              </section>
