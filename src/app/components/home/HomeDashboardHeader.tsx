    ...
    <section className="px-4 pb-8 pt-12 md:px-6 md:pb-8 md:pt-16">
      <div className="mx-auto max-w-screen-2xl">
        <div className="max-w-3xl space-y-4">
          ...
          <h1 className="text-4xl font-semibold leading-[1.05] tracking-tight text-foreground md:text-5xl">
            Welcome back,{' '}
          ...
          <p className="max-w-2xl text-base leading-relaxed tracking-normal text-muted-foreground">
