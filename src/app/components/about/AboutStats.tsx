    ...
    <section className="relative px-4 py-20 md:px-6 md:py-28">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mb-12 text-center">
          <p className="mb-3 text-xs uppercase tracking-[0.28em] text-primary">Our library</p>
          <h2 className="text-3xl font-bold text-foreground md:text-4xl">Content in numbers</h2>
        </div>
