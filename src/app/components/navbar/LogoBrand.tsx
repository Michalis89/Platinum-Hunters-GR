...
export function LogoBrand({ href }: { href: string }) {
  return (
    <Link
      href={href}
      className="group flex items-center gap-2.5 rounded-lg px-1 transition-transform duration-200 [transition-timing-function:var(--easing-default)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/45 active:scale-[0.99]"
    >
