...
export function LogoBrand({ href }: { href: string }) {
  return (
    <Link
      href={href}
      className="group flex items-center gap-2 rounded-lg px-1 transition-transform duration-200 [transition-timing-function:var(--easing-default)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/45 active:scale-[0.99] md:gap-2.5"
    >
      ...
      <span className="whitespace-nowrap text-[13px] font-semibold tracking-[-0.015em] text-foreground sm:text-[14px]">
        Hobbistas
      </span>
    </Link>
  );
