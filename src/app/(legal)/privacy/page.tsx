            ...
            <PageHeader
              ...
              description={
                <>
                  ...
                  <span className="font-semibold text-primary">{SITE_NAME}</span> collects, stores,
                  and processes your personal data when you use the website{' '}
                  <a
                    href={SITE_URL}
              ...
              eyebrowClassName="tracking-[0.25em] text-muted-foreground"
              descriptionClassName="text-sm leading-relaxed text-foreground md:text-base"
              metaClassName="text-xs text-muted-foreground opacity-70"
            />
          </section>

          {/* Content */}
          <section className="rounded-3xl border border-border bg-card p-6 text-sm leading-relaxed text-foreground shadow-xl md:p-8 md:text-base">
            <div className="space-y-6">
              ...
              <section>
                ...
                <p>
                  ...
                  concerning the protection of personal data, you may contact us at:
                </p>
                <p className="mt-1 font-medium text-primary">{SITE_CONTACT_EMAIL}</p>
              </section>
              ...
              <section>
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  <li>
                    <span>Account information:</span> email address, username, encrypted password,
                    account creation date.
                  </li>
                  <li>
                    <span>Profile information (optional):</span> display name, full name, country,
                    bio, platform IDs (PSN, Xbox, Steam), favorite genres, favorite platform, gaming
                    start year.
                  </li>
                  <li>
                    <span>Usage data:</span> profile settings, backlog entries, game status,
                    playtime hours you enter, articles you create or edit.
                  </li>
                  <li>
                    <span>Technical information:</span> IP address, browser type, approximate device
                    type, basic logs for security and debugging purposes.
                  </li>
                  <li>
                    <span>Cookies &amp; similar technologies:</span> authentication cookies and
                    session tokens via Supabase, and any strictly necessary cookies for platform
                    functionality.
                  </li>
                </ul>
              ...
              <section>
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  <li>
                    <span>Account creation and management:</span> to allow you to log in, save your
                    backlog, manage your profile, etc. (legal basis: performance of contract).
                  </li>
                  <li>
                    <span>Security &amp; protection:</span> to prevent abuse, malicious activity,
                    and unauthorized access (legal basis: legitimate interest).
                  </li>
                  <li>
                    <span>Communication with you:</span> for email verification, password reset, and
                    account-related notifications (legal basis: performance of contract / compliance
                    with user requests).
                  </li>
                  <li>
                    <span>Service improvement:</span> basic usage analysis, statistics, and feedback
                    (legal basis: legitimate interest). We do not conduct profiling or advertising
                    targeting.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  Your data is primarily stored on infrastructure provided by <span>Supabase</span>{' '}
                  (database, authentication), as well as hosting infrastructure used to operate{' '}
              ...
              <section>
                ...
                <p>We do not sell, rent, or trade your personal data. Data may be shared:</p>
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  <li>
              ...
              <section>
                ...
                <p className="mt-2">
                  ...
                  <span className="font-medium text-primary">{SITE_CONTACT_EMAIL}</span>. We will
                  respond within a reasonable timeframe and in accordance with applicable legal
                  frameworks.
                </p>
                <p className="mt-2 text-xs text-muted-foreground">
              ...
              <section>
                ...
                <p className="mt-2">
                  As a result, neither{' '}
                  <span className="font-semibold text-primary">{SITE_NAME}</span> nor its
                  administrators have access to actual passwords. In case of password loss, recovery
                  is performed exclusively through secure email verification links.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  . In case of any conflict, the provisions that better protect your rights as a
                  data subject shall prevail.
                </p>
              </section>

              <p className="pt-4 text-xs text-muted-foreground opacity-70">
