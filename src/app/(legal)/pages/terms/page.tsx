...
export const metadata = buildMetadata({
  title: 'Όροι Χρήσης | Hobbistas',
  description: 'Διάβασε τους όρους χρήσης της υπηρεσίας Hobbistas.',
  path: '/pages/terms',
});
            ...
            <div className="space-y-6">
              ...
              <section>
                ...
                <p>
                  Ο{' '}
                  <span className="font-semibold text-[var(--hb-primary-strong)]">{SITE_NAME}</span>{' '}
                  είναι μία διαδικτυακή πλατφόρμα για καταγραφή backlog, reviews και σχετικού
              ...
              <section>
                ...
                <p>
                  ...
                  όπως κείμενα, σχόλια, βαθμολογίες κ.λπ. («Περιεχόμενο Χρήστη»). Παραμένοντας
